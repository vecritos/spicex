...
In this section we'll walk through hobbies, habits, and estimates as a framework to identify a path forward.
These ideas help us learn to slowly adjust, or micro-steer, our life.
...
Over the course of the article we will build these into a successful future.

A common online breakdown we will use as an example is as follows: 
...
It is okay to have multiple hobbies in the same category for now, we will breakdown how to isolate them. 

### Personalized Goals

Many times people hear "workout" and picture free-weights, and yet the best exercise is the one you do.
With this in mind, accept it is okay to get creative in your list of hobbies.
...
This lowers the activation energy because there are shared traits in each hobby.
I'll use myself as an example here, I am a programmer who reads and writes code.
And so I am seeking to combine my creative hobby with my income stream.
I might find myself enjoying reading and writing in english because I can use my computer.
As a bonus, spoken languages are thought provoking and creative.
And another positive, is spoken languages do not need to be interpreted by a computer, so these are less stressful.
...
These are the basis for which we'll construct the remainder of our plan.

Next we will create a holistic view of who you are as a person right now.
Often times it is called a curriculum vitae (cv), and depending on your profession it can vary in format.
A photographer might want a [portfolio](https://www.instagram.com/astrobackyard/?hl=en) on social media, while as a programmer I might want a [website](https://ironsides.app).

The importance of such documents becomes clearer when talking about life directions.
In life, it's easy to fall into traps of stating "I haven't done anything with my life".
These are self-defeating thought patterns, the less of them the better. 
The curriculum vitae (cv) serves as a good counter-argument to yourself.
With these you'll start to focus on what experiences you are gaining. 
...
These skills are closer to your life's current hobbies.
Goals will form later to keep these hobbies thriving.

It's important to care about what other things people have going on as well.
As such, you don't always have to add something to your curriculum vitae (cv).
It is okay to do things for just fun or community. 

In contrast, in feeling accomplished it helps to define you in the future.
Working up to the mindset of continuous improvement. 
If you want to give back, add a volunteer section to your cv.
Work on expanding that list with more organizations that encourage volunteer work.

My recommendation for relaxing is to find a hobby that alters your mindset.
This could be reading, meditating, or watching entertaining shows or movies.
When watching something find real-life parallels that you can use as examples or relate back to.
For extroverts it could be study groups or social mixers.
These allow for mingling with people of varying backgrounds.
And each step of the way you can learn something new through engaging with peers. 

Now go over the previous hobby list.
Look to see if the hobbies can help foster compounding abilities.
If not, combine hobbies in the same category, rewrite how you perform the hobby, or nix the hobbies.
Identify isolated, individual, and exciting hobbies for each subcategory.
Remember these are what you want to improve in this section of your life.
...
I look for a meme that makes me laugh out loud.
After laughing I put my phone away and go back to my previous task.
It's a good mental break, and an influx of dopamine.
The habit of stopping when you've achieved a laugh prevents hours of scrolling past memes that are "moderately amusing". 
To make it personable, I like to make faux-conversations up with memes.
Conversations help me find meme-gold easier and get off my phone quicker.

#### Further Personalization

After our hobbies we can momentarily refocus.
Take some personality tests.
These can include but are not limited to: Emotional Intelligence Surveys, Myers-Briggs, SWOT Analysis, DISC Assessment, or the Big Five (OCEAN).
These tests will help you isolate how you move through the world.
It can be in respect to your hobbies or peer interactions.
Based on your results feel free to revise the hobby list.
Keep in mind if you do you'd be changing what you enjoy doing for what a test says you enjoy doing.

Feel free to do these in groups.
Additionally, have an external feedback session on yourselves.
This allows for feedback on how others interpret you.
Activities like this may show you that your peers did not know your hobbies all along.
This can provide new avenues to comradery.
An example is you and your peer discover you both love biking.
...
Rotation through different roles helps express various aspects of being you.
And in rotating roles you can test the hobbies that help you grow.

From these personality tests work towards identifying important values.
Values in this sense are re-occurring themes in your results that coincide with your hobbies.
From the re-occurring results we can form a framework for long term goals.
For these results, identify a handful of leaders who embody the base values you have created.
This is our backup plan if we ever feel we are loosing touch with the world
If so, then we will use these leaders and the organizations.
...
We factor in opportunity cost when personalizing our hobbies.
Due to the fact that the reality of who you are might be lurking at the pottery studio down the street.
...
Breaking down life segments in eras gives you permission to have long-term goals.
This breakdown can help you in abstaining from societal expectations.
...
Now we can dig down into the goals.
We will seek to fully answer why you want these goals in this era. 
Rephrase the goals until you can easily answer why you chose that goal.
This technique will help you identify flaws in your motivation.
Motivation isn't some awe-inspiring moment each day where you have all the energy to do something.
Stemming from a deeper sense of discipline motivation is ambition.
Ambition you have in each hobby when worth of the effort in showing up regardless is clear.
The location and implementation of a goal becomes clearer when you dig down into the "why" behind your original statement.
The "test of the whys" will result in simple goals, or hobby-missions in our case.
These are more to the point of changing your life direction.
Rather than grind-culture-of-expectations our goals work by acquiring new skills and experience.
In this instance you can learn to adjust your life towards a longer term goal.
...
The breakdown of effort based on the fibonacci sequence was used to estimate tasks per sprint.
A sprint is an iteration of work on the project, to translate: about two weeks of time.
For example, in one of my more agile organizations we used `21` to indicate about a sprint's worth of work.
In our personal lives we can use a similar approach. 
...
The breakdown of about a month of effort fits nicely into the `30-60-90 days to form habits` mentality.
...
This can compound and eventually you're surrounded by new approaches to life.
New approaches keep the novelty, and satisfy the "change addicts". *Humanocracy*
The smaller estimates like `8`, `13`, or `21` become metrics by which you can evaluate your progress.
Whether you're enjoying it is more qualitative but we can use the flexibility of estimates to cover our problem.

For instance in the example of volunteering you can say "for my moon estimate I'm going to volunteer more".
So for a sub-goal it may make sense that every time we complete `8` (or go to a weekly volunteer event) it is added to the cv.
Every time I meet somebody in need twice I'll consider them a new friend (a `21` on the fibonacci sequence in our moon estimate).
This allows for a quantitative and qualitative metric based on the original goal.
In our case, changing the world for the better through volunteering. 
Through this method we can create mini-games for your life.
These mini-games give us a sense of progress with a fun preliminary mindset.
...
In this method you assign many of the ordinary tasks in your hobby to the sequence.
Then upon reaching a cumulative score of `89` or above you can switch hobbies.
This will give you a goal within the hobby you started to make your life better.
These phase-goals, or an `89`, gives you an end goal in sight.
In cases where you want to switch it up later on, you can.
ANd who knows what will happen, that's the beauty of fibonacci based estimates.

An example of this could be painting.
Every painting is worth `13` points.
When you have reached **7** (or `89` divided by `13` = 6.85) paintings you can switch to another hobby.
Feel free to donate the paints to a local school, or save them and come back later.
Additionally, in our painting example, you could assign different fibonacci sequence values to different sized paintings.
A `0` could be that you picked up the paintbrush at all that day.

Another example is being happy as a goal.
A `1` could mean forcing a smile for a minute.
The other `1` could mean forcing the superman pose for a minute.
...
Identifying a schedule can cause lots of anxiety.
Someone who realizes that we don't know what will happen tomorrow may experience some anxiety.
...
We can focus on creating best-order anti-worst-case scenarios in your life.
These scenarios assist in managing your life over the course of your growth.
Scenarios are formed using the basis of habit creation.
During the initial segment of a moon estimate you might not know what habits need to be formed right away.
We might have collected an end term, or `89` and a few smaller activities `8, 13, 5`.
...
We'll walk through an example of best-order anti-worst-case scenario by leveraging the power of combining our hobbies.
In our example we'll take exercise, one of our original example hobbies.
...
- Best-Order: I'll wait until I get frustrated and then the next opportunity I have for a walk I'll go de-stress. 
- Best-Order: I'll take it during the timeframe the sun comes out (especially in winter).
- Anti-Worst-Case: In this aspect I can mitigate one instance of being frustrated per-day or get some sunlight and Vitamin-D.
...
Some time zones like a working schedule are more restrictive on which hobbies can be performed.
However, working on a relevant certification may be allowed, so ask your manager.

#### Fallback Hobbies as Anti-Worst-Case

It is beneficial when working on a subset of your hobby list to have fall back plans.
In the scenario when the power goes out, your morning routine of checking the news may not be available. 
Instead of skipping that time, reallocate it.
If our example is checking the news, maybe you have a fallback plan of having a book ready.
This could be an older, politically savvy account of history.
You can replace the time with the fallback and keep your schedule relatively consistent.
This works while also building the same habit of updating yourself.
Other fallbacks can be formed for all your hobbies.
When you isolate **when** you want to do things, you can build these backup hobbies.
In this aspect one small unplanned adjustment to your activities does not throw off your whole day.
We build redundancies into our engineered systems in this way.
So logically, building for our personal or professional lives is a good expansion.

### More Examples

If your goal is to expand your knowledge base by reading but you're often restless, there is hope.
By focusing on the worst-case (being tired during the day) we can reason that waiting until you are tired to begin reading can offset the restlessness.
In this way the natural rhythm of your body will work with you towards making progress towards the goal of reading.

For simple but repetitive tasks that's essential to forward progress, like job applications, doing these before a meal can ease the time between now and eating.
...
A personal example is that I often deal with anxiety or stress.
For me it was beneficial to get my workout after the days events (around 11PM).
This sort of opportunistic scheduling allowed for a mental reset before bed.
The next day of similar stress was postponed and I looked forward to my exercise. 
This is one of the things about opportunistic scheduling, get to know yourself first.
Then you can plan your day with activities to look forward to.
...
Feel free to be more generic about the categorization.
I thought these would fit well in the examples.

It's all about finding ways to put forth a little effort on something you have to do.
Alongside the effort, minimizing the routine difference should some aspect go wrong.
...
Search for challenges regardless of the organizational restrictions.
We can benefit long-term by combining our personal challenges.
Challenges can include growth in our hobbies and skill sets, new financial or business opportunities, or new social circles.

These personal challenges shine while using the methodology of the fibonacci sequence.
The different aspects of our lifestyle change or moon estimate can be tracked as well and viewed visually.
Knowing this, there has to be a catch, so we will talk briefly about the [Learning Pit](https://learningpit.org/).

The Learning Pit is the idea that learning progress will slow down until a baseline knowledge amount is created.
...
Then it can be argued that if you set your ambitions as 80% of the ambition result you will leave 20% as room for improvement.

For instance if I set my ambitions on writing this article that 80% of the work.
Then finishing my own leadership portfolio and writing a rough draft completes that amount of effort.
The remaining 20% is enhancing this article for the next generation.
And the next 20% after that is expanding it to include other texts as well.
So incremental improvements on the same task can yield beneficial end results.

This method may give some Key-Performance-Indicator obsessed managers a headache. 
However granting more flexibility on the things we find interesting is beneficial for continuous improvement. 
I thought I'd share this mentality in case somebody feels they are underachieving.
Now you can go in with this expectation of leaving room for improvement.
Having already planned out where to go when you feel you need to do more.
You can direct yourself as preparing for always improving.

A sub task of ours is making habits flexible enough to deal with life's stressors.
If we are successful, you will find yourself better able to cope with life.
Using the moon estimates when setting your schedule helps plan for the smallest change over the next moon.
As long as these compound, the changes can be as large or as small as you want. 
We can even count if you tuck your shoe laces in when taking off your shoes. 
...
To begin, start by writing down a list of activities of all the things you do during the week.
It is okay to use a different timeframe if that works better.
...
Then add the minutes per week you think you spend performing these tasks, it is okay to use a calculator, and see what the total amount of time spent is.
Then divide the total by the number of minutes in a week, it is okay to use hours for these calculations if that makes the activity easier, 
...
- (total time written during the activity per week, in minutes) / 10080 minutes per week = weekly time utilization in minutes
...
Busyness we can define as the time that is taken up by things that do not compound.
Productivity we can define as things which can compound positively.
Those activities which you can build an end result from participating in them.
...
This will give us some thinking room by which to discard, redo, or modify our activities for something more productive.
As for the ones currently labelled productive we'll now dive deeper into them.
We can search for possible ways to make these more productive through efficiency.
...
To identify and keep track of these small improvements in our life we can (optionally) break out the [A3 Report](https://www.lean.org/lexicon-terms/a3-report/).
The A3 Report is a style of planning improving systems.
We will use this professional template in a lifestyle metric.
We can then breakdown hypothesis on what small changes we can make moving forward.

Start with the things on your productivity list.
Try to come up with a few (2+) reasons on why this thing takes up that amount of time.
Imagine if you had to go into an attic to get your toothbrush every time you wanted to brush your teeth.
Look for reasons why these things are time consuming. 
The results do not have to be issues with the tasks, just why they take time.

Identify a few things in this scenario that could be improved.
For instance, would you rather spend 10 minutes focused on review or 60 minutes on all book sections.
Try to fill out the possible improvements on what would time look like if we could prioritize.
After this, look for opportunities to prioritize.
Write these prioritization opportunities down or discuss them.
Soon you will see there is always a few small changes that can be made.
...
> while reducing the count of processes, tools, and documentation necessary,
...
With these ideas in mind we are able to obtain a new mentality.
This mentality focuses on improvement over iterations.
And these iterations yield greater successes in the long term.
We can account for change as part of our mindset of adaptation.
And use this change to accelerate our time-based version of cashback.

### Waste Products

Non-value adding wastes are additional things that consume excess time or energy.
Find and remove busyness in productivity activities by identifying waste products.
As you gain a capacity to recognize these waste products you can identify flaws in efficiency.
These inefficient techniques become things that only slow you down.
In this instance the best thing to do is to nix it.
We make our goal to "reduce non-value adding wastes" *Taiichi Ohno*.
...
And a paper towel in case of a spill will also do just fine.

My favorite example of this is to ask someone where do they slice their bread.
Is it worth the extra few seconds to slice it at home.
Or is asking the person with the mechanical slicer a better use of time.
Remember our engineering mindset of tracking time wastes.
In this scenario we factor in things like the time it takes to get out the cutting board.

In *Star Wars* Darth Sidious works to convince others to join The Dark Side of The Force.
He says The Dark Side is "a pathway to many abilities some consider to be unnatural".
In his speech he is showcasing how powerful and influential somebody can become.
Permitted, of course, they join The Dark Side of the Force.
Analyzing time frames in life is a pathway I make a case for in this article.
That being said, I promise to not plot against the Light Side of The Force in this era. 

Time frame analysis allows you to make decisions based on guaranteed freedom of time.
The freedom of time is the ability to gain seconds in all of life's activities.
Thus, by accumulating seconds enough times, a minute is gained.
Consequentially, you can find yourself gaining time.
Reallocating the time consumed by an activity is looking for innovative improvements in each task. 

For some tasks like work or studying it is more difficult to reduce the time needed.
Innovations or incremental learning strategies can reduce the overall time needed.
Small improvements can be automatically gained if you focus on the quality of sleep, study, and skill.

In this sense you can gain "abilities some consider to be unnatural" by making the best-timing possible choices for each hobby.
If some hobbies stick around, great, you have gained lifelong skills.
And if you are unsure of what to do, that is why we use moon estimates, we have a path towards finding improvements.
If we are lucky as a hobby based culture, we may have gained something, someone, or some place that makes us smile.

Eventually all the time adds up and you have achieved the ability to tackle more problems.
By planing for time optimization through efficiency we gain time.
We gain time by avoiding optimizing non-essential but expected tasks.
Non-essential tasks are created by your own expectations or those expectations imposed upon you. 
With our new ability to discern between useful or not useful we can compound improvements.

### Finances and Opportunity

A small note on money and opportunity.
These can follow if you find what you are passionate about.
Hopefully through discussions with mentors, friends, forums or otherwise you will find opportunities.
These can lead to growing your network and your skills while surrounded by like-minded individuals. 

#### Finding Benefits in Small Changes and Lifestyles

I can provide an example of how small shifts in mentality will adapt your lifestyle.
These adaptations are sometimes difficult to describe.
Here is the advice: Place lost objects back in the location where your instincts checked first.
...
These techniques if you critique them or share them with friends can provide a collection of tactics to your life.
Optional activity: try to build some in a group, see what tricks you come up with for identifying tactics.
...
Keeping that in mind, I'll leave you with two more sections on different mentalities that have helped me move forward and I can now express in writing.

### Question not Doubt

When focusing on yourself and making decisions, avoid viewing yourself in a negative light.
Question not doubt your past or your ability to have done better in those situations.

Questioning through asking productive open ended questions is beneficial.
Open ended questioning brings a clarity of ideals, additional topics, as well as opening the door for future expansion.
Often times we ask for constructive criticism in our interactions with our peers.
When talking to yourself you deserve no less respect.
Attempts to make constructive criticism on your past can be difficult.
So we can observe two different approaches and leave room for you to come up with more.
...
And thus, we plan out a future based on past experience.
In this way, you can have an action plan in place if a similar situation occurs again.
These plans can accumulate and will help you feel more prepared for the future.
Feel free to document or outline your plans.
There is always a place to come back to or to reference when you move forward.
...
In such instances as questioning your experiences, asking yourself what you learned is a way to view any experience in an opposing light.
...
We can move forward balanced in the aspects of good-decision-at-the-time and consistent improvement approaches.
...
With questioning we figure out how to improve in our progress.
...
These might help your mentality when studying a new topic, preparing for interviews, or meeting new friends.
...
Sections of this article could be useful for consideration in your own writing or study.
These were gleaned from The Roy and Marcia Engineering Leadership Institute at The University of Toledo.
They are a great way to construct your own portfolio and see where you are, where you want to be, and how to get there.
...
The subject is focused on undergraduate engineering students; however, this is released publicly for anyone who has interest in the topics.
It was originally adapted from the module for Sigma Phi Epsilon - Ohio Iota nicknamed "You're Not As Busy As You Think You Are"

The basis for these notes was both activities participated, modules, books, and lectures performed at school.
They are not presented to be a scientific article or change someone's life, it is a topic to discuss. 

The article is a look into how efficiency, opportunistic scheduling, and personal-focused research can benefit long term productivity.
I will leave you with a final quote from *jeff* "everyday you're not getting stronger [in some way] you're getting weaker".
For questions I am available by email at [isadiewei@pm.me](mailto:isadiewei@pm.me?Subject=Hello%20David%20--%20Agile%20Moon).
...
- Peter's Laws The Creed of the Sociopathic-Obsessive (subset of laws) nicknamed by myself "The Spaceman's Creed"
