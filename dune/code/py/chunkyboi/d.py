...
def run_pipeline(
    ...
    with open(input_path, "rb") as src:
        ...
        while True:
            ...
            fut = _executor.submit(
                ...
                config,
                index == 0,
                False,  # provisional; corrected later
            )
            futures[fut] = index
            index += 1
    ...
    # Fix last-chunk flag semantics if needed by transform
    # (Transforms that care should buffer internally)
    # Kept intentionally simple and explicit
